...
from schemas import UserCreate, UserResponse, GroupCreate, GroupResponse, GroupMembersCreate, GroupMembersResponse, BillCreate, BillResponse, ItemCreate, ItemResponse, VoteCreate, VoteResponse, GoogleAuthRequest, AuthResponse
from split_calculator import SplitCalculator
from image_processing import extract_items_from_receipt
from file_validator import FileValidator
from rate_limiter import rate_limit
from auth_utils import GoogleTokenVerifier, JWTManager, UserService
...
jwt_manager = JWTManager(JWT_SECRET_KEY, JWT_ALGORITHM, JWT_EXPIRATION_SECONDS)
...
async def get_current_user(
    ...
    Updated to use the new JWT manager and user service.
    """
    ...
    try:
        # Verify JWT token using the new JWT manager
...
# === Client-Side OAuth Authentication Routes ===
